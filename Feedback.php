...
<body>	 
	  ...
	  <h1><b><i><big>Your Feedback</big></i></b></h1>
		<img id="pic" src="Images/imageedit_8_8852923974.gif" width="55%" height="35%" align="right">
	
	<form class="glasslog"  name="frmcontact"  method="post" action=" " onsubmit="return formValidate()">
			<label for="name">Your name:</label><br>
			<input id="name" class="input" name="inputname" type="text" value="" size="30" /><br><br><br>
			
		
		
			<label for="message">Your message:</label><br>
			<textarea id="message" class="input" name="tmessage" rows="7" cols="30"></textarea><br><br><br>
