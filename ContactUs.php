...
<body>	 
		<div id="bg"></div>
			...
			<h1><b><i><big>Contact Us</big></i></b></h1>
			<img id="pic" src="Images/imageedit_61_5751156408.gif" width="55%" height="35%" align="right">

<form class="glasslog" action=" " name="cform" method="POST" enctype="multipart/form-data" onsubmit="return formValidate()">			
			<label for="name">Your name:</label><br>
			<input id="name" class="input" name="name" type="text" value="" size="30" /><br><br><br>
		
		
			<label for="email">Your email:</label><br>
			<input id="email" class="input" name="email" type="text" value="" size="30" /><br><br><br>
		
		
			<label for="message">Your message:</label><br>
			<textarea id="message" class="input" name="message" rows="7" cols="30"></textarea><br><br><br>
